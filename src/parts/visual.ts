...
export class Visual extends Canvas {
  ...
  protected _update(): void {
    ...
    this._scrollItem.setSize(itemSize, 10, scrollItemSize * 0.5);
    ...
    this._item.forEach((val) => {
      ...
      const rad = Util.instance.map(v, maxRadius, 0, 0, scrollItemSize * 0.5);
      val.setRadius(rad);
    })
  ...
  _resize(isRender: boolean = true): void {
    ...
    const interval = Func.instance.val(1.5, 2);
